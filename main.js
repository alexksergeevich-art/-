const VER = "dragon-queue-lvl5-red-20260307d";
...
const SPRITES = {
  ...
  lvl5: {
    down:      { url:`assets/LVL5/LVL5_down_sprite.png?v=${VER}`,      frameW:696, frameH:688, frames:12, fps:10, footOffsetPx:103 },
    right:     { url:`assets/LVL5/LVL5_right_sprite.png?v=${VER}`,     frameW:696, frameH:688, frames:12, fps:10, footOffsetPx:123 },
    downRight: { url:`assets/LVL5/LVL5_rightdown_sprite.png?v=${VER}`, frameW:696, frameH:688, frames:12, fps:10, footOffsetPx:173 },
    upRight:   { url:`assets/LVL5/LVL5_upright_sprite.png?v=${VER}`,   frameW:696, frameH:688, frames:12, fps:10, footOffsetPx:105 },
    up:        { url:`assets/LVL5/LVL5_up_sprite.png?v=${VER}`,        frameW:696, frameH:688, frames:12, fps:10, footOffsetPx:75 },
    idleFront: { url:`assets/LVL5/LVL5_idledown_sprite.png?v=${VER}`,  frameW:696, frameH:688, frames:12, fps:8,  footOffsetPx:103 },
    idleBack:  { url:`assets/LVL5/LVL5_idleup_sprite.png?v=${VER}`,    frameW:696, frameH:688, frames:12, fps:8,  footOffsetPx:51 },
    attack:    { url:`assets/LVL5/LVL5_attack_sprite.png?v=${VER}`,    frameW:696, frameH:688, frames:12, fps:15, renderScale:1.14, footOffsetPx:9 },
    death:     { url:`assets/LVL5/LVL5_death_sprite.png?v=${VER}`,     frameW:696, frameH:688, frames:12, fps:11, footOffsetPx:1 },
    winner:    { url:`assets/LVL5/LVL5_winner_sprite.png?v=${VER}`,    frameW:696, frameH:688, frames:12, fps:8,  footOffsetPx:61 },
    uiName: "LVL 5"
},
  dragon: {
...
const HERO_CONFIG = {
  ...
  4: { id:"lvl4", ringIndex:3, maxHp:360, damage:74, speed:166, attackRange:112, attackCooldown:0.70, dragonThreat:50 },
  5: { id:"lvl5", ringIndex:4, maxHp:520, damage:118, speed:170, attackRange:124, attackCooldown:0.62, dragonThreat:68 },
};
...
function makeDragonApproachSlots(){
  ...
  return offsets.map(([ox, oy]) => clampToWalkable({ x: state.dragon.x + ox, y: state.dragon.y + oy }));
}
...
function updateHero(hero, dt){
  ...
  hero.spriteEl.style.filter = hero.level === 4
...
function validateSpriteManifest(){
  const groups = [SPRITES.lvl1, SPRITES.lvl2, SPRITES.lvl3, SPRITES.lvl4, SPRITES.lvl5, SPRITES.dragon];
...
resize();
syncAllQueueBadges();
status(`LVL 1–5 подключены. LVL5 добавлен в общую очередь, получил красную ауру сильнее LVL4 и усиленные статы.`);
