const VER = "dragon-queue-lvl4-goldfix-20260307c";
...
const HERO_SLOT_BY_LEVEL = { 1:0, 2:1, 3:3, 4:4 };
const ROUTES = {
  1: [
...
resize();
syncAllQueueBadges();
status(`LVL 1–4 подключены. LVL4 выровнен по кругу, бой у дракона идет по 5 точкам, золото-свечение и усиленный урон включены.`);
