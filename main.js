...
const SPRITES = {
  ...
  lvl5: {
    down:      { url:`assets/LVL5/LVL5_down_sprite.png?v=${VER}`,             frameW:696, frameH:688, frames:8, fps:10, footOffsetPx:103 },
    right:     { url:`assets/LVL5/LVL5_right_sprite.png?v=${VER}`,            frameW:696, frameH:688, frames:8, fps:10, footOffsetPx:123 },
    downRight: { url:`assets/LVL5/LVL5_rightdown_sprite.png?v=${VER}`,        frameW:696, frameH:688, frames:8, fps:10, footOffsetPx:173 },
    upRight:   { url:`assets/LVL5/LVL5_upright_sprite.png?v=${VER}`,          frameW:696, frameH:688, frames:8, fps:10, footOffsetPx:105 },
    up:        { url:`assets/LVL5/LVL5_up_sprite.png?v=${VER}`,               frameW:696, frameH:688, frames:8, fps:10, footOffsetPx:75 },
    idleFront: { url:`assets/LVL5/LVL5_idledown_sprite.png?v=${VER}`,         frameW:696, frameH:688, frames:8, fps:8,  footOffsetPx:103 },
    idleBack:  { url:`assets/LVL5/LVL5_idleup_sprite.png?v=${VER}`,           frameW:696, frameH:688, frames:8, fps:8,  footOffsetPx:51 },
    attack:    { url:`assets/LVL5/LVL5_attack_sprite.png?v=${VER}`,           frameW:696, frameH:688, frames:8, fps:15, renderScale:1.14, footOffsetPx:9 },
    death:     { url:`assets/LVL5/LVL5_death_sprite.png?v=${VER}`,            frameW:696, frameH:688, frames:8, fps:11, footOffsetPx:1 },
    winner:    { url:`assets/LVL5/LVL5_winner_sprite.png?v=${VER}`,           frameW:696, frameH:688, frames:8, fps:8,  footOffsetPx:61 },
    uiName: "LVL 5"
  },
  dragon: {
